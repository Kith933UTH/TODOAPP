...
function TodoItem(todo, index, editingIndex) {
  console.log(document.getElementById(todo.id).classList.contains('enableEditing'))
    ...
    <div class="todo-item-view">
      ...
      />
      <div class="todo-item-wrap-content" ondblclick="dispatch('enableEditing', ${index}) || document.getElementById('edit-title${index}').focus()">
